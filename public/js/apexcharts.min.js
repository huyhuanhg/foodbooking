    ...
    var A = {
        ...
        return a(t, [{
            ...
            key: "svgUrl", value: function () {
                this.cleanup();
                var t = this.getSvgString(), e = new Blob([t], {type: "images/svg+xml;charset=utf-8"});
            ...
            key: "dataURI", value: function () {
                ...
                return new Promise((function (e) {
                    ...
                    if (window.canvg && f.isIE11()) {
                        ...
                        var h = "data:images/svg+xml," + encodeURIComponent(n), c = new Image;
                        c.crossOrigin = "anonymous", c.onload = function () {
                            if (r.drawImage(c, 0, 0), a.msToBlob) {
                                var t = a.msToBlob();
                                e({blob: t})
                            } else {
                                var i = a.toDataURL("images/png");
                                e({imgURI: i})
                            }
                        }, c.src = h
                    }
